...
public class UHTree {
	...
	/*
	 * Crea una nuevo UHTree cuyos hash estan en el rango [0, 2^2^order[. Order
	 * es un entero entre 0 y 5 inclusive
	 */
	...
	/*
	 * Elimina un elemento del arbol, devuelve true si y solo si dicho elemento
	 * existia en el arbol.
	 */
